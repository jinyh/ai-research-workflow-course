...
- 第 11 课讲义已起草（v0.1.0），本课承接段已写入 handout §六，需对照第 11 课讲义复核衔接表述。
...
1. **第 11 课承接**：第 11 课讲义已起草（v0.1.0），本课承接段见 handout §六与 teaching-plan §一，需对照第 11 课讲义复核衔接表述（特别是循环骨架→八要素的对应关系）。
