...
| [slides.md](./slides.md) | 现行·逐页母稿 v0.1.0（30 页草稿） | gate4 逐页六段：屏显内容、视觉结构、教师讲述备注、互动、建议时间、来源与事实边界 |
...
- [x] **gate2 内容门（三件套草稿）**：`handout.md`、`teaching-plan.md`、`slides.md`（§一 + 逐页六段草稿）、`README.md` 已建立；引用同一套课程规则、同一批案例、同一来源口径；讲义面向学生可独立阅读；教案不替代讲义；本课无正式提交、课后推进到第 13 课验证门；来源入口齐全（Wooldridge & Jennings 1995、van der Aalst 2003、Anthropic *Building Effective Agents*、MCP Architecture、AutoResearch、Lu et al. 2026）。
- [x] **gate3 90 分钟教学门（草稿）**：`teaching-plan.md` §四 90 分钟流程表 + `slides.md` §一节奏表，时段、页码、环节、产出对齐。
- [x] **gate4 逐页映射门（草稿）**：`slides.md` §一逐页映射表 30 页每页标明 handout 内容母稿位置；逐页六段（屏显内容/视觉结构/教师讲述备注/互动/建议时间/来源与事实边界）已填草稿级。
...
3. **贯穿案例虚构性标注**：handout §五与 slides P21-P22 的"每周证据地图更新"为虚构教学情境，须在课堂讲述中明确标注，不得被后续材料当作真实研究结论。
4. **页码与节奏微调**：slides 30 页与 90 分钟节奏的匹配需在逐页映射门复核时验证（如八要素段 P05-P12 共 8 页 14 分钟、设计段 P17-P22 共 6 页 18 分钟）。
...
7. **PPT 设计准则**：slides 视觉结构已按 ppt-design-criteria 反卡片准则起草（主视觉优先真实研究工件、轮廓轮换、密度双轨），关键页（P04/P09/P12/P21/P23/P25）需在制作前填四字段设计契约。
