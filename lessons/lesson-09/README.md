...
| [keystone-design-spec.md](./keystone-design-spec.md) | 现行·关键页设计规格 v1.0.1 | 12 个风险触发关键页的四字段契约、模板例外与验收约束 |
...
- 页数：20；画布：16:9。
- 最终文件 SHA-256：`0defa78196781209aadd2defb7882ac057185234b5718c0026e59a836a5f5ae5`。
