...
第 3-5 课完成了检索、精读和证据地图，产出了研究空白候选。但研究空白本身还不是研究问题。"还没有论文写过 X"只能说明地图上有一个空格，不说明这个空格值得填充、能否在课程周期内做出最小验证、以及填充后能回答什么。
...
以贯穿案例为例。第 5 课的缺角空白候选 G1 是：在相关工作矩阵中，"阅读卡是否强制定位原文"这一子问题整列空白，经窄检索确认没有可直接对应的核验材料。
...
| 序号 | 门条件 | 自查问题 | 对应项目文件 |
| --- | --- | --- | --- |
| 1 | 至少 10 篇候选文献或等价外部材料，并标注证据角色 | 候选文献表是否含 10 篇以上？每篇是否标注了主证据/补充/对比/探索线索？ | 候选文献表 |
| 2 | 至少 3 篇核心材料的完整精读卡 | 是否有 3 张以上完整精读卡？每张是否记录了正式书目信息、作者主张、关键证据及原文位置、实验设置或论证前提、适用范围和局限？ | `reading-cards.md` |
| 3 | AI 辅助阅读时，精读卡包含 AI 初始阅读地图、至少两个原文核验位置、AI 的错误/过度概括/遗漏或已检查风险，以及最终人工判断 | 每张精读卡是否保留了 AI 初始阅读地图（标记为未核验）？是否记录了至少两个可复查的原文位置？是否记录了 AI 的错读或已检查风险？是否有最终人工判断？ | `reading-cards.md` |
| 4 | 一个证据地图初版，能够区分直接证据、补充证据、冲突和空白 | 证据地图是否区分主证据、补充证据、对比证据和证据空白？冲突是否被显式保留？ | `evidence-map.md` |
| 5 | 一个明确的研究问题，包含范围、非例和至少一个可证伪命题 | 研究问题是否具体到条件、对象、干预和结果？是否写出至少一个非例？是否写出至少一个可证伪命题（指明什么观察会推翻它）？ | `problem-definition.md` |
| 6 | 一份第一性原理推导，写出必要条件、关键约束或可检验前提 | 是否完成四步推导（基本约束、作用机制、不可违背条件、待验证前提）？推导是否在文献和证据地图基础上进行，而非凭空构造？ | `problem-definition.md` 或 `proposal.md` |
...
`problem-definition.md` 应至少包含以下字段（对齐 [starter-template.md](../../course/starter-template.md) §3）：
...
承接第 5 课贯穿案例。第 5 课产出：证据地图初版 + 研究空白候选 G1（缺角空白：阅读卡是否强制定位原文→降低遗漏，经窄检索和三步检验通过）。
...
对照 §五·2 的 8 项门条件逐项自查。确认：候选文献 ≥ 10 篇（第 3 课产出）、精读卡 ≥ 3 张（第 4 课产出）、证据地图初版（第 5 课产出）、研究问题 + 非例 + 可证伪命题（本课产出）、第一性原理推导（本课产出）、重要性说明（本课产出）、AI 使用记录（第 1-5 课持续回写）。
...
对照 §五·2 的 8 项门条件，逐项自查当前项目版本。标注已满足、待补全和未满足的条目，并写出未满足条目的修复计划。
