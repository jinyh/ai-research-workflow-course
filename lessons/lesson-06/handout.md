...
适用课次：第 6 课
文档类型：学生正式讲义（草稿）
状态：gates 1-4 通过；问题门八项条件、第 3-6 课累计路径和虚构教学案例边界已对齐
变更记录：
...
| 第 5 课 | 相关工作矩阵初版 + 证据地图初版 + 空白候选 | 根据地图的空白和引用路径做窄检索，把已核验候选表从至少 6 篇扩展到至少 10 篇，并补齐 3 张精读卡的缺失字段 | 30-45 分钟 | `notes/literature-search.md` + `notes/reading-cards/` + `evidence-map.md` | 不单独提交；作为第 6 课入口状态 |
