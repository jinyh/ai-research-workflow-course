...
| 文件 | 角色 | 用途 |
| --- | --- | --- |
| [handout.md](./handout.md) | 现行·学生讲义 v0.4.0 | 面向学生、可脱离课堂独立阅读：综述结构、相关工作矩阵、问题门证据地图四视图、四态进入规则、研究空白三类与三步检验、四句 mini literature review |
| [teaching-plan.md](./teaching-plan.md) | 现行·教师教案 v0.4.0 | 90 分钟流程、PPT 执行索引、演示脚本、课堂产出验收、讲后复盘 |
| [slides.md](./slides.md) | 现行·逐页母稿 v0.5.0（19 页） | 逐页屏显文案、视觉结构、讲述备注、互动、时间、来源与事实边界 |
