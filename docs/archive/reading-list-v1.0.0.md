...
1. **核心**：[Wang et al., *Scientific discovery in the age of artificial intelligence*](https://www.nature.com/articles/s41586-023-06221-2)。阅读引言、总览图和与本人研究方向相关的一节；用于识别 AI 介入科研链路的位置与边界。本地正式版见 [PDF](../ref/papers/s41586-023-06221-2.pdf)。
...
3. **课堂节选**：[Terence Tao, *Mathematics in the Age of AI*](../ref/age-of-ai-icm-2026.pdf)。选取 AI 使用层级、证明消化链和披露相关页面；作为“AI 改变研究动作但不替代研究责任”的跨学科案例。
...
本清单由 [research-method 选目分析](../ref/research-method-选目分析.md) 和 [库外补充推荐](../ref/research-method-补充推荐.md) 交叉筛选形成，并按课程最新 16 次课结构重新取舍。两份分析是备课决策记录，不应直接作为学生阅读材料。
