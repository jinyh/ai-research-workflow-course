...
- v1.0.0 (2026-07-29)：初版逐课阅读清单，已归档至 [docs/archive/reading-list-v1.0.0.md](../docs/archive/reading-list-v1.0.0.md)。
...
不得向外部模型上传未公开论文、保密评审材料、敏感数据或许可不允许处理的全文。AI 生成的作者、题名、年份、页码、DOI 和引文必须回到正式来源逐项核验。
...
3. **任选｜原始综述论文｜约 25 分钟**
   Wang, H. et al. “Scientific discovery in the age of artificial intelligence.” *Nature* 620, 47–60 (2023). DOI: [10.1038/s41586-023-06221-2](https://www.nature.com/articles/s41586-023-06221-2)。选读引言、总览图和与本人方向相关的一节。本地正式版见 [PDF](../ref/papers/s41586-023-06221-2.pdf)。
   用途：定位 AI 介入科学发现链路的环节、机会与限制。

### 课堂案例

4. **演讲案例**
   Terence Tao. *Mathematics in the Age of AI* (ICM 2026 public lecture). [本地讲稿](../ref/age-of-ai-icm-2026.pdf)。只分析 AI 使用层级、证明消化链、限制披露和演讲叙事，不把其中的能力数据视为课程已核验结论。
...
1. **核心｜正式规范｜约 15 分钟**
   中国科学院学部科学道德建设委员会：《关于在科研活动中规范使用人工智能技术的诚信提醒》（2024）。[官方页面](https://www.cas.cn/sygz/202409/t20240910_5031186.shtml)
...
3. **任选｜前沿原始论文｜约 25 分钟**
   Lu, C. et al. “Towards end-to-end automation of AI research.” *Nature* (2026). DOI: [10.1038/s41586-026-10265-5](https://www.nature.com/articles/s41586-026-10265-5)。本地正式版见 [PDF](../ref/papers/s41586-026-10265-5.pdf)。
...
本清单由 [research-method 选目分析](../ref/research-method-选目分析.md) 和 [库外补充推荐](../ref/research-method-补充推荐.md) 提供候选，再回到出版社、期刊、会议、政府、学术组织或作者机构页面核验。
